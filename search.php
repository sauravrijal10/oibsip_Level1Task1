...
if (isset($_POST['save'])) {
    if (!empty($_POST['search'])) {
        ...
        $stmt = $con->prepare("SELECT * FROM electronics1 WHERE id LIKE '%$search%' OR Product_name LIKE '%$search%'");
        $stmt->execute();
...
<!---------- Banner HTML Code Ends --------->
      ...
      <div class="section2" id="products">
        ...
        <div class="card-container col-md-9" id="Card-wrapper">
...
?>
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\phones\macbook.jpg" alt="">
         </div>
         <div class="card-info">
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\perfume\ck.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\phones\dell.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\phones\galaxy-s22.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\phones\huwai.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\phones\iphone.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\phones\lenovo.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\phones\vivo-y11s-2.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\perfume\blueberry.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\perfume\jimmy.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\perfume\lancome.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\book\foodever.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\book\got.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\book\harrypotter.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
       ...
       <div class="card-button">
        ...
        <!--Card end-->
         ...
         <div class="card">
         <div class="card-img">
          <img src="images\book\howtowin.jpg" alt="">
         </div>
         <div class="card-info">
          <p class="text-title">Product title </p>
          <p class="text-body">Product description and details</p>
